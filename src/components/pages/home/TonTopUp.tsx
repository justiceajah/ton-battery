...
const TonTopUp = () => {
  return (
    <div className="relative mt-[80px] md:mt-0 lg:static lg:mt-40">
      ...
      <div className="mx-sm-container mt-10 lg:mx-container">
        ...
        <div className="rounded-[70px] bg-[#D9D9D912] bg-opacity-[0.07] px-5 py-10 text-white md:p-11">
          <div className="flex flex-col justify-between gap-6 lg:flex-row">
            ...
            <div className="w-full lg:w-[48%]">
              <div className="flex flex-col gap-4 gap-x-0 md:gap-6 lg:gap-8">
                ...
                <ul className="text-base font-semibold md:text-xl lg:text-2xl">
                  <li>- 300 NOT</li>
                  <li>- 3 USDt</li>
                </ul>
              </div>
